          ...
          <div class="row">
            <div class="col-xl-8 col-lg-12 col-md-12">
              <div class="hero__caption hero__caption2">
                <h1 data-animation="bounceIn" data-delay="0.2s">Rəylər</h1>

                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo base_url('home') ?>">Ana səhifə</a></li>
                    <li class="breadcrumb-item"><a href="#">Rəylər</a></li>
                  </ol>
                </nav>
      ...
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-8">
          <div class="section-tittle text-center mb-55">
            <h2 style="color: #16164C;">Rəylər</h2>
          </div>
        </div>
      </div>
      <div class="row">

        <?php foreach ($get_all_testimonials as $item) { ?>
                ...
                <div class="properties__card">
                  ...
                  <?php }else{ ?>
                    <a href="<?php echo base_url("testimonial_single/" . $item['testimonial_id']) ?>"><img
                        ...
                        src="<?php echo base_url('uploads/testimonials/logo.png') ?>" alt=""></a>
                  <?php } ?>
