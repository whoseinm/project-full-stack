...
<div class="container">
    <div class="card">
        ...
        <h5 class="card-header spaceB">Təlim create
        ...
        <?php if ($this->session->flashdata('err')) { ?>
            ...
            <form action="<?php echo base_url('studyAbroad_create_act'); ?>" method="post" enctype="multipart/form-data">
                <label for="title">Yerin adı</label>
                <input type="text" id="title" name="title" class="form-control">
                <br>

                <label for="description">Yer Haqqında</label>
