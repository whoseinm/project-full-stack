...
<div class="container">
    <div class="card">
        ...
        <?php if ($this->session->flashdata('err')) { ?>
            ...
            <form action="<?php echo base_url('vacancy_edit_act/').$vacancy_single['vacancy_id']; ?>" method="post" enctype="multipart/form-data">
                <label for="title">Title</label>
                <input type="text" id="title" name="title" class="form-control" value="<?php echo $vacancy_single['vacancy_name']; ?>">
                <br>

                <label for="descr">Description</label>
                <textarea name="description" class="form-control" id="description" cols="30" rows="10" ><?php echo $vacancy_single['vacancy_about']; ?></textarea>
                <br>

                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="float: left;">
                    <label for="date">Date</label>
                    <input type="date" class="form-control" id="date" name="date" value="<?php echo $vacancy_single['vacancy_add_date']; ?>">
                </div>
                ...
                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    ...
                    <option <?php if ($vacancy_single['vacancy_status'] == "") {
                                    echo "SELECTED";
                                } ?> value="">-SELECT-</option>
                        <option <?php if ($vacancy_single['vacancy_status'] == "Active") {
                                    echo "SELECTED";
                                } ?> value="Active">Active</option>
                        <option <?php if ($vacancy_single['vacancy_status'] == "Deactive") {
                                    echo "SELECTED";
                ...
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="float: left; margin:0px">
                    ...
                    <?php if ($vacancy_single['vacancy_img']) { ?>
                        ...
                        <?php } else { ?>
                            <img width="100%" style="object-fit: cover;" src="<?php echo base_url('uploads/vacancy/' . $vacancy_single['vacancy_img']); ?>" alt="">

                            <a href="<?php echo base_url('vacancy_img_delete/'.$vacancy_single['vacancy_id']); ?>">
