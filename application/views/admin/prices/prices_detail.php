...
<div class="container">
    <div class="card">
        ...
        <h5 class="card-header spaceB">Qiymət Detalları
        ...
        <?php if ($this->session->flashdata('err')) { ?>
            ...
            <form action="<?php echo base_url('prices_create_act'); ?>" method="post" enctype="multipart/form-data">
                <label for="title"><b>Uğurun adı</b></label>
                <p><?php echo $Prices_single['price_name'];?></p>
                <br>

                <label for="descr"><b>Description</b></label>
                <p><?php echo $Prices_single['price_about'];?></p>
                <br>

                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="float: left;">
                    <label for="date"><b>Date</b></label>
                    <p><?php echo $Prices_single['price_add_date'];?></p>
                </div>
                ...
                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    ...
                    <p><?php echo $Prices_single['price_status'];?></p>
                </div>

                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    <label for="status"><b>Creator</b></label>
                    <p><?php echo $Prices_single['a_name'];?></p>
                </div>

                <?php if ($Prices_single['price_updater_id'] != 0){ ?>
                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    <label for="cate"><b>Updater</b></label>
                    <p><?php echo $Prices_single['price_updater_id'];?></p>
                </div>
            <?php }else{ ?>
            ...
            <?php }?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="float: left; margin:0px">
                    ...
                    <?php if(!empty($Prices_single["price_img"])){ ?>
                        <img width="150px" height="150px" src="<?php echo base_url("uploads/prices/".$Prices_single["price_img"]) ?>" alt="">
                    <?php }else{ ?>
