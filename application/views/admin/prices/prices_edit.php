...
<div class="container">
    <div class="card">
        ...
        <h5 class="card-header spaceB">Qiymət edit
            <a href="<?php echo base_url('prices_admin') ?>">
        ...
        <?php if ($this->session->flashdata('err')) { ?>
            ...
            <form action="<?php echo base_url('prices_edit_act/').$Prices_single['price_id']; ?>" method="post" enctype="multipart/form-data">
                <label for="title">Title</label>
                <input type="text" id="title" name="title" class="form-control" value="<?php echo $Prices_single['price_name']; ?>">
                <br>

                <label for="descr">Description</label>
                <textarea name="description" class="form-control" id="description" cols="30" rows="10" ><?php echo $Prices_single['price_about']; ?></textarea>
                <br>

                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="float: left;">
                    <label for="date">Date</label>
                    <input type="date" class="form-control" id="date" name="date" value="<?php echo $Prices_single['price_add_date']; ?>">
                </div>
                ...
                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    ...
                    <option <?php if ($Prices_single['price_status'] == "") {
                                    echo "SELECTED";
                                } ?> value="">-SELECT-</option>
                        <option <?php if ($Prices_single['price_status'] == "Active") {
                                    echo "SELECTED";
                                } ?> value="Active">Active</option>
                        <option <?php if ($Prices_single['price_status'] == "Deactive") {
                                    echo "SELECTED";
                ...
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="float: left; margin:0px">
                    ...
                    <?php if ($Prices_single['price_img']) { ?>
                        <?php if (empty($Prices_single['price_img'])) { ?>
                            <img width="100%" style="object-fit: cover;" src="http://raddiantdiagnostics.com/wp-content/uploads/2019/12/no_img.jpg" alt="">

                        <?php } else { ?>
                            <img width="100%" style="object-fit: cover;" src="<?php echo base_url('uploads/prices/' . $Prices_single['price_img']); ?>" alt="">

                            <a href="<?php echo base_url('prices_img_delete/'.$Prices_single['price_id']); ?>">
