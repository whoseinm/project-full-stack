...
<div class="container">
    <div class="card">
        ...
        <h5 class="card-header spaceB">Testimonial create
            <a href="<?php echo base_url('vacancies_list') ?>">
        ...
        <?php if ($this->session->flashdata('err')) { ?>
            ...
            <form action="<?php echo base_url('testimonial_create_act'); ?>" method="post" enctype="multipart/form-data">
                <label for="title">Rəyi yazanın adı</label>
                <input type="text" id="title" name="title" class="form-control">
                <br>

                <label for="description">Rəy Haqqında</label>
