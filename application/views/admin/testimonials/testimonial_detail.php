    ...
    <div class="card">
        ...
        <?php if ($this->session->flashdata('err')) { ?>
            ...
            <form action="<?php echo base_url('vacancy_create_act'); ?>" method="post" enctype="multipart/form-data">
                ...
                <p><?php echo $testimonial_single['testimonial_name'];?></p>
                <br>

                <label for="descr"><b>Description</b></label>
                <p><?php echo $testimonial_single['testimonial_about'];?></p>
                <br>

                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="float: left;">
                    <label for="date"><b>Date</b></label>
                    <p><?php echo $testimonial_single['testimonial_add_date'];?></p>
                </div>
                ...
                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    ...
                    <p><?php echo $testimonial_single['testimonial_status'];?></p>
                </div>

                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    <label for="status"><b>Creator</b></label>
                    <p><?php echo $testimonial_single['a_name'];?></p>
                </div>

                <?php if ($testimonial_single['testimonial_updater_id'] != 0){ ?>
                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    <label for="cate"><b>Updater</b></label>
                    <p><?php echo $testimonial_single['testimonial_updater_id'];?></p>
                </div>
            <?php }else{ ?>
            ...
            <?php }?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="float: left; margin:0px">
                    ...
                    <?php if(!empty($testimonial_single["testimonial_img"])){ ?>
                        <img width="150px" height="150px" src="<?php echo base_url("uploads/testimonials/".$testimonial_single["testimonial_img"]) ?>" alt="">
                    <?php }else{ ?>
