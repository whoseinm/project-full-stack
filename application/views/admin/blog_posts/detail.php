    ...
    <div class="card">
        ...
        <?php if ($this->session->flashdata('err')) { ?>
            ...
            <form action="<?php echo base_url('post_create_act'); ?>" method="post" enctype="multipart/form-data">
                ...
                <p><?php echo $post_single['post_title'];?></p>
                <br>

                <label for="descr"><b>Description</b></label>
                <p><?php echo $post_single['post_description'];?></p>
                <br>

                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="float: left;">
                    <label for="date"><b>Date</b></label>
                    <p><?php echo $post_single['post_date'];?></p>
                </div>
                ...
                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    ...
                    <p><?php echo $post_single['post_category'];?></p>
                </div>


                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    <label for="status"><b>Status</b></label>
                    <p><?php echo $post_single['post_status'];?></p>
                </div>

                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    <label for="status"><b>Creator</b></label>
                    <p><?php echo $post_single['a_name'];?></p>
                </div>

                <?php if ($post_single['post_updater_id'] != 0){ ?>
                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    <label for="cate"><b>Updater</b></label>
                    <p><?php echo $post_single['post_updater_id'];?></p>
                </div>
            <?php }else{ ?>
            ...
            <?php }?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="float: left; margin:0px">
                    ...
                    <br>
                    <?php if(!empty($post_single["post_img"])){ ?>
                        <img width="150px" height="150px" src="<?php echo base_url("uploads/posts/".$post_single["post_img"]) ?>" alt="">
                    <?php }else{ ?>
