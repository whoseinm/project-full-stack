...
<div class="container">
    <div class="card">
        ...
        <h5 class="card-header spaceB">Təlim planı create
        ...
        <?php if ($this->session->flashdata('err')) { ?>
            ...
            <form action="<?php echo base_url('plan_create_act'); ?>" method="post" enctype="multipart/form-data">
                <label for="title">Təlimin planının adı</label>
                <input type="text" id="title" name="title" class="form-control">
                <br>

                <label for="description">Təlim Planı Haqqında</label>
