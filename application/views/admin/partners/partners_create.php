...
<div class="container">
    <div class="card">
        ...
        <h5 class="card-header spaceB">Partner create
        ...
        <?php if ($this->session->flashdata('err')) { ?>
            ...
            <form action="<?php echo base_url('partner_create_act'); ?>" method="post" enctype="multipart/form-data">
                <label for="title">Partnyorun Adı</label>
                <input type="text" id="title" name="title" class="form-control">
                <br>

                <label for="description">Partnyor Haqqında</label>
                ...
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="float: left; margin:0px">
                    ...
                    <input type="file" id="img" class="form-control" name="partner_img">
                </div>
