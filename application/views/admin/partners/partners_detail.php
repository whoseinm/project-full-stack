    ...
    <div class="card">
        ...
        <?php if ($this->session->flashdata('err')) { ?>
            ...
            <form action="<?php echo base_url('post_create_act'); ?>" method="post" enctype="multipart/form-data">
                <label for="title"><b>Partnyorun adı</b></label>
                <p><?php echo $partners_single['partner_name'];?></p>
                <br>

                <label for="descr"><b>Description</b></label>
                <p><?php echo $partners_single['partner_about'];?></p>
                <br>

                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="float: left;">
                    <label for="date"><b>Date</b></label>
                    <p><?php echo $partners_single['partner_add_date'];?></p>
                </div>
                ...
                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    ...
                    <p><?php echo $partners_single['partner_status'];?></p>
                </div>

                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    <label for="status"><b>Creator</b></label>
                    <p><?php echo $partners_single['a_name'];?></p>
                </div>

                <?php if ($partners_single['partner_updater_id'] != 0){ ?>
                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="float: left; margin:0px 10px">
                    <label for="cate"><b>Updater</b></label>
                    <p><?php echo $partners_single['partner_updater_id'];?></p>
                </div>
            <?php }else{ ?>
            ...
            <?php }?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="float: left; margin:0px">
                    ...
                    <br>
                    <?php if(!empty($partners_single["partner_img"])){ ?>
                        <img width="150px" height="150px" src="<?php echo base_url("uploads/partners/".$partners_single["partner_img"]) ?>" alt="">
                    <?php }else{ ?>
