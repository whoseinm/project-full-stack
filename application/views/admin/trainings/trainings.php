...
<div class="container">
    <div class="card">
        <h5 class="card-header spaceB">Təlimlərin Siyahısı
            <a href="<?php echo base_url('training_create') ?>">
            ...
            <div class="table-responsive text-nowrap">
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <?php $say = 0;
                        foreach ($get_all_trainings as $item) {
                            strrev($say++) ?>
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $title = mb_strimwidth($item['training_name'], 0, 30, '...');
                                    echo $title ?>
                                </td>
                                </td>
                                <td>
                                    <?php echo date("d-m-Y", strtotime($item['training_add_date'])); ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php if ($item["training_img"]) { ?>
                                        <img width="70px" height="60px" style="object-fit: cover;"
                                            src="<?php echo base_url('uploads/trainings/' . $item['training_img']); ?>" alt="img"></img>
                                    <?php } else { ?>
                                ...
                                <td>
                                    <?php if ($item['training_status'] == "Active") { ?>
                                        <span class="badge bg-label-success me-1">
                                            <?php echo $item['training_status']; ?>
                                        </span>
                                    <?php } else if ($item['training_status'] == "Deactive") { ?>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo base_url("training_detail/". $item["training_id"]) ; ?>">
                                        <button type="button" class="btn btn-sm btn-outline-info">Detail</button>
                                    </a>
                                    <a href="<?php echo base_url("training_edit/". $item["training_id"]) ; ?>">
                                        <button type="button" class="btn btn-sm btn-outline-warning">Edit</button>
                                    </a>
                                    <a href="<?php echo base_url("training_delete/". $item["training_id"]) ; ?>">
