...
<div class="container">
    <div class="card">
        ...
        <h5 class="card-header spaceB">Özəl create
        ...
        <?php if ($this->session->flashdata('err')) { ?>
            ...
            <form action="<?php echo base_url('special_course_create_act'); ?>" method="post" enctype="multipart/form-data">
                <label for="title">Özəl Kursun adı</label>
                <input type="text" id="title" name="title" class="form-control">
                <br>

                <label for="description">Kurs Haqqında</label>
